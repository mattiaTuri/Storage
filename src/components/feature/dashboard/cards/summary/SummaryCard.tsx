    ...
    return (
        <Card className="bg-white dark:bg-[#262626] dark:border-[#434343] border">
            <CardContent className="text-white flex flex-col justify-center h-full gap-2">
                ...
                <StatisticsNumberBox title="Books" data={bookList.books} loading={bookList.loading} primaryColor="#efa135" secondaryColor="#ffbf00"/>
                <StatisticsNumberBox title="Resources" data={resourcesList.resources} loading={resourcesList.loading} primaryColor="#0066ff" secondaryColor="#17c0fd"/>
                <StatisticsNumberBox title="Tasks" data={bookList.books} loading={bookList.loading} primaryColor="#522aa7" secondaryColor="#6d39de"/> 
            </CardContent>
        </Card>
    )
}
