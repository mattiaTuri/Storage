...
function BookTab() {
  ...
  return (
    <Box sx={{ width: "100%" }} className="flex flex-col h-full">
      ...
      <CustomModal
        title={t("filters")}
        btnId="btnApplyFilter"
        btnTitle={t("apply_filters")}
      ...
      <CustomModal
        ...
        btnId="btnAddBook"
        btnTitle={t("save")}
        btnFunction={addNewBook}
        open={modals.addBooksModal.visibility}
        initialValues={initialBooksValues}
        setValues={setBookValues}
        closeFunction={() => dispatch(setAddBooksModalVisibility(false))}
      >
        <BooksField
